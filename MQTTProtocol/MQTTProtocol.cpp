...
MQTTProtocol::MQTTProtocol():_mqData(NULL),_ptype(0),_mtype(CLIENT),_dried(0),_stream(NULL)
{
}

MQTTProtocol::MQTTProtocol(char* content,int mtype):_mtype((Mtype)mtype),_dried(0),_stream(NULL)
{
...
MQTTProtocol::MQTTProtocol(int type, int dried, int dup,int qos):_ptype(type),_dried(dried),_stream(NULL)
{
