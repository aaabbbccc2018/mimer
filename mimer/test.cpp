...
void test_send_ACK(msgTypes ptype, int dried)
{
...
void test_send_onlyHeader(msgTypes ptype, int dried)
{
	MIMPacket pkt(ptype, dried);
...
void test_send_CONNECT(int dried)
{
...
void test_send_CONNACK(int dried)
{
...
void test_send_PUBLISH(int dried)
{
...
void test_send_PUBACK(int dried)
{
	test_send_ACK(PUBACK, dried);
}

void test_send_PUBREC(int dried)
{
	test_send_ACK(PUBREC, dried);
}

void test_send_PUBREL(int dried)
{
	test_send_ACK(PUBREL, dried);
}

void test_send_PUBCOMP(int dried)
{
	test_send_ACK(PUBCOMP, dried);
}

void test_send_SUBSCRIBE(int dried)
{
...
void test_send_SUBACK(int dried)
{
...
void test_send_UNSUBSCRIBE(int dried)
{
...
void test_send_UNSUBACK(int dried)
{
	test_send_ACK(UNSUBACK, dried);
}

void test_send_PINGREQ(int dried)
{
...
void test_send_PINGRESP(int dried)
{
	test_send_onlyHeader(PINGRESP, dried);
}

void test_send_DISCONNECT(int dried)
{
	test_send_onlyHeader(DISCONNECT, dried);
}
